...
- [x] Структура данных апгрейдов
  ...
  - [ ] Система категорий апгрейдов
    - [ ] Добавить поле `category` в JSON структуру
    - [ ] Создать конфигурацию категорий (click_upgrades, auto_click_upgrades, multiplier_upgrades)
    - [ ] Цветовая дифференциация и иконки для категорий
    - [ ] Группировка апгрейдов по категориям в UI
...
- [x] UI апгрейдов
  ...
  - [ ] Улучшение ShopPanel (эволюция вместо создания UpgradePanel)
    - [ ] Добавить вкладки режимов: "Магазин" и "Апгрейды"
    - [ ] Режим "Магазин": покупка новых апгрейдов
    - [ ] Режим "Апгрейды": управление существующими, статистика, аналитика
...
- **Вкладка "Апгрейды":** Управление существующими, статистика, аналитика
