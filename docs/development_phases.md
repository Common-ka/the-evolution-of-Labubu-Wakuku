...
#### Оставшиеся задачи:
- [ ] Визуальные эффекты (Фаза 2)
  - [ ] Floating Text: всплывающий текст с показом получаемой валюты
  - [ ] CPUParticles2D: эффекты частиц при клике (звездочки/искры)
...
- [ ] Система частиц
  - [ ] CPUParticles2D для эффектов кликов
  - [ ] Анимации покупок в магазине
- [ ] UI анимации
  - [ ] Floating Text для показа валюты
