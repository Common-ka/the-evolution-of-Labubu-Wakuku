...
- [x] Навигация между сценами
  ...
  - [x] Базовый магазин из игрового поля (HUD → ShopPanel)
    ...
    - [x] Два апгрейда клика (мультипликаторы)
    - [x] Сохранение уровней апгрейдов в прогрессе
...
- [ ] Система валюты и прогрессии
  ...
  - [ ] Множители кликов
    - [ ] Постоянные (апгрейды, достижения, престиж) — мультипликативные
...
- [ ] UI апгрейдов
  ...
  - [ ] Система покупки с подтверждением
- [ ] Логика апгрейдов
